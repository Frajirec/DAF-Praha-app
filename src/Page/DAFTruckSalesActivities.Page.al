page 80016 "DPG DAF Truck Sales Activities"
{
    // // @ Area Vehicle
    // +----------------------------------------------+
    // | Copyright (c) incadea                        |
    ...
    Caption = 'Truck Sales Activities';
    PageType = CardPart;
    ...
    layout
    {
        area(content)
        {
            ...
            {
                ShowCaption = false;
                field("Vehicles To Order"; "Vehicles To Order")
                {
                    DrillDownPageID = "Vehicle Sales Order List";
                }
                field("Vehicles Ordered"; "Vehicles Ordered")
                {
                    DrillDownPageID = "Vehicle Sales Order List";
                }
                field("Vehicles Received"; "Vehicles Received")
                {
                    DrillDownPageID = "Vehicle Sales Order List";
                }
                field("Vehicles Shipped"; "Vehicles Shipped")
                {
                    DrillDownPageID = "Vehicle Sales Order List";
                }
                field("Vehicles Purch Ordered"; "Vehicles Purch Ordered")
                {
                }
                field("Vehicles Purch To Receive"; "Vehicles Purch To Receive")
                {
                }
                field("Vehicles Purch To Invoice"; "Vehicles Purch To Invoice")
                {
                }
                field("Service Order lines to create"; "Service Order lines to create")
                {
                }
                field("PO Veh. Transfer to create"; "PO Veh. Transfer to create")
                {
                }
            }
        }
