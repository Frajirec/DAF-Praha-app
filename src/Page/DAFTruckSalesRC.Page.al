page 80017 "DPG DAF Truck Sales RC"
{
    // // @ Area Vehicle
    // +----------------------------------------------+
    // | Copyright (c) incadea                        |
    ...
    Caption = 'Vehicle Back Office RC';
    ...
    layout
    {
        area(rolecenter)
        {
            ...
            {
                ShowCaption = false;
                part(Control1000000000; "DPG DAF Truck Sales Activities")
                {
                }
                part(Control1000000002; "DPG DAF GDPR Activities")
                {
                }
                part(Control1000000005; "DPG DAF Truck Sales Stock")
                {
                }
