report 80005 "DPG Posted Unilateral Credit" // 1057703 "Posted Unilateral Credit"
{
    // --- NAVCZ ---
    // API.1.0.4  18.10.18 DV New report based on report 31057
    // --- API Customization ---
    // --- DAFCZ ---
    // DAFCZ.1    26.10.18 DV DAFCZ.1 Added some text required by DAF CZ
    DefaultLayout = RDLC;
    RDLCLayout = './src/Report/PostedUnilateralCredit.rdlc';
    ...
    labels
    {
        Label001 = 'We hereby announce to you that we have conducted in accordance with §1982 et seq. Of the Civil Code unilaterally credit the below specified mutual claims.';
    }

    var
        Text000: Label 'ANNOUNCEMENT %1';
        ...
        by_reciprocally_credit_receibables_by_par364_Business_LawCaptionLbl: Label 'by unilateral credit receivables and liabilities by PAR. 1982-1991 of Civil Code No. 89/2012';
        ...
        SummaryText: Label '%1 pay the difference of this unilaterall settlement of receivables and payables of %2 %3 to company %4 to %5';
}
