report 80046 "DPG Vehicle Sales Invoice"
{
    // --- API Customization ---
    // // @ Area VehicleSales
    // +----------------------------------------------+
    ...
    // --- DAFCZ ---
    // DAFCZ.1    02.11.18 DV DAFCZ.1 Created new report by copy of report 1057603
    DefaultLayout = RDLC;
    RDLCLayout = './src/Report/VehicleSalesInvoice.rdlc';
        ...
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(Collective_TextShowOutput_C_INC033__PrintAddrBlock_; CollectiveG.TextShowOutput(C_INC033, PrintAddressBlockG))
                    {
                    }
                    ...
                    column(RePrintOriginalInvG; RePrintOriginalInvoiceG)
                    {
                    }
                    ...
                    column(ShowDiscPctG; ShowDiscountPctG)
                    {
                        Description = 'PA033336';
                    }
                    column(PrintFooterLine_Control1101339004; PrintFooterLineBlockG)
                    {
                        Description = 'PA033336';
                    }
                    ...
                    column(PrintSentFromLineG_; RDLHideOutput(PrintSentFromLineBlockG))
                    {
                        Description = 'PA035395.18593';
                    }
                    ...
                    {
                        DataItemTableView = SORTING(Number);
                        column(Collective_TextShowOutput__Sales_Invoice_Line__FIELDCAPTION__Unit_of_Measure___ShowUnitsofMeasure_; CollectiveG.TextShowOutput(SalesInvLine2G.FIELDCAPTION("Unit of Measure"), ShowUnitsOfMeasureFieldG))
                        {
                        }
                        column(Collective_TextShowOutput_C_INC009_ShowDiscPctG_; CollectiveG.TextShowOutput(C_INC009, ShowDiscountPctG))
                        {
                        }
                        ...
                        column(PrintOption; PrintOptions2G)
                        {
                            Description = 'PA033336';
                        }
                        ...
                        column(Collective_TextShowOutput_FORMAT_ROUND_ShowLineDiscPct_0_01___ShowDiscPctG_; CollectiveG.TextShowOutput(FORMAT(ROUND(ShowLineDiscPctG, 0.01)), ShowDiscountPctG))
                        {
                        }
                        ...
                        column(Collective_TextShowOutput__Sales_Invoice_Line___Unit_of_Measure__ShowUnitsofMeasure_; CollectiveG.TextShowOutput(SalesInvLine2G."Unit of Measure", ShowUnitsOfMeasureFieldG))
                        {
                        }
                        ...
                        column(Collective_TextShowOutput__Sales_Invoice_Line___Unit_of_Measure__ShowUnitsofMeasure__Control1109400023; CollectiveG.TextShowOutput(SalesInvLine2G."Unit of Measure", ShowUnitsOfMeasureFieldG))
                        {
                        }
                        ...
                        column(Collective_TextShowOutput_FORMAT_ROUND_ShowLineDiscPct_0_01___ShowDiscPctG__Control69; CollectiveG.TextShowOutput(FORMAT(ROUND(ShowLineDiscPctG, 0.01)), ShowDiscountPctG))
                        {
                        }
                        ...
                        column(Collective_TextShowOutput__Sales_Invoice_Line___Unit_of_Measure__ShowUnitsofMeasure__Control67; CollectiveG.TextShowOutput(SalesInvLine2G."Unit of Measure", ShowUnitsOfMeasureFieldG))
                        {
                        }
                        ...
                        column(Collective_TextShowOutput__Sales_Invoice_Line___Unit_of_Measure__ShowUnitsofMeasure__Control1109400027; CollectiveG.TextShowOutput(SalesInvLine2G."Unit of Measure", ShowUnitsOfMeasureFieldG))
                        {
                        }
                        column(Collective_TextShowOutput_FORMAT_ROUND_ShowLineDiscPct_0_01___ShowDiscPctG__Control1109400000; CollectiveG.TextShowOutput(FORMAT(ROUND(ShowLineDiscPctG, 0.01)), ShowDiscountPctG))
                        {
                        }
                        ...
                        column(Collective_TextShowOutput__Sales_Invoice_Line___Unit_of_Measure__ShowUnitsofMeasure__Control1109400009; CollectiveG.TextShowOutput(SalesInvLine2G."Unit of Measure", ShowUnitsOfMeasureFieldG))
                        {
                        }
                        ...
                        column(Collective_TextShowOutput__Sales_Invoice_Line___Unit_of_Measure__ShowUnitsofMeasure__Control1109400032; CollectiveG.TextShowOutput(SalesInvLine2G."Unit of Measure", ShowUnitsOfMeasureFieldG))
                        {
                        }
                        ...
                        column(Collective_TextShowOutput_FORMAT_ROUND_ShowLineDiscPct_0_01___ShowDiscPctG__Control145; CollectiveG.TextShowOutput(FORMAT(ROUND(ShowLineDiscPctG, 0.01)), ShowDiscountPctG))
                        {
                        }
                        ...
                        dataitem(Vehicle; Vehicle)
                        {
                            ...
                            begin
                                ...
                                // Start PA035597
                                PrintOptionHelpG := (PrintOptions2G <> PrintOptions2G::"Print no lines");
                                // Stop PA035597
                            end;
                        ...
                        dataitem("Optn Var. Vehicle"; "Posted Option Variant")
                        {
                            ...
                            column(Collective_TextShowOutput_FORMAT_ROUND_ShowLineDiscPct_0_01___ShowDiscPctG__Control1109400006; CollectiveG.TextShowOutput(FORMAT(ROUND(ShowLineDiscPctG, 0.01)), ShowDiscountPctG))
                            {
                            }
                            ...
                            column(Collective_TextShowOutput_FORMAT_ROUND_ShowLineDiscPct_0_01___ShowDiscPctG__Control148; CollectiveG.TextShowOutput(FORMAT(ROUND(ShowLineDiscPctG, 0.01)), ShowDiscountPctG))
                            {
                            }
                            ...
                            column(Collective_TextShowOutput__Sales_Invoice_Line___Unit_of_Measure__ShowUnitsofMeasure__Control190; CollectiveG.TextShowOutput(SalesInvLine2G."Unit of Measure", ShowUnitsOfMeasureFieldG))
                            {
                            }
                            ...
                            begin
                                ...
                                // Start PA035597
                                PrintOptionHelpG := (PrintOptions2G <> PrintOptions2G::"Print no lines");
                                PrintUnitPriceHelpG := (PrintUnitPriceOptionG <> PrintUnitPriceOptionG::"Print no prices");
                        ...
                        dataitem("Optn Var. Color"; "Posted Option Variant")
                        {
                            ...
                            column(Collective_TextShowOutput_FORMAT_ROUND_ShowLineDiscPct_0_01___ShowDiscPctG__Control144; CollectiveG.TextShowOutput(FORMAT(ROUND(ShowLineDiscPctG, 0.01)), ShowDiscountPctG))
                            {
                            }
                            ...
                            begin
                                ...
                                // Start PA035597
                                PrintOptionHelpG := (PrintOptions2G = PrintOptions2G::"Print all lines") OR
                                  ((PrintOptions2G = PrintOptions2G::"Print selected lines") AND "Optn Var. Color"."Print Option Line");
                        ...
                        dataitem("Optn Var. Series"; "Posted Option Variant")
                        {
                            ...
                            begin
                                // Start PA035597
                                PrintOptionHelpG := (PrintOptions2G = PrintOptions2G::"Print all lines") OR
                                  ((PrintOptions2G = PrintOptions2G::"Print selected lines") AND "Optn Var. Series"."Print Option Line");
                        ...
                        dataitem("Option Variant"; "Posted Option Variant")
                        {
                            ...
                            column(Collective_TextShowOutput_FORMAT_ROUND_ShowLineDiscPct_0_01___ShowDiscPctG__Control172; CollectiveG.TextShowOutput(FORMAT(ROUND(ShowLineDiscPctG, 0.01)), ShowDiscountPctG))
                            {
                            }
                            ...
                            begin
                                ...
                                // Start PA035597
                                PrintOptionHelpG := (PrintOptions2G = PrintOptions2G::"Print all lines") OR
                                  ((PrintOptions2G = PrintOptions2G::"Print selected lines") AND "Option Variant"."Print Option Line");
                        ...
                        begin
                            ...
                            THEN BEGIN
                                ...
                                IF SalesInvLine2G.Type = SalesInvLine2G.Type::Item THEN BEGIN
                                    CASE SalesInvLine2G."Item Type" OF
                                        SalesInvLine2G."Item Type"::Item:
                                            IF (PrintUnitPriceOptionG = PrintUnitPriceOptionG::"Print all prices") AND
                                               (PrintOptions2G = PrintOptions2G::"Print selected lines") AND
                                               SalesInvLine2G."Print Option Line" OR
                                               (PrintUnitPriceOptionG = PrintUnitPriceOptionG::"Print all prices") AND (PrintOptions2G = PrintOptions2G::"Print all lines") OR
                                               ((PrintUnitPriceOptionG = PrintUnitPriceOptionG::"Print selected prices") AND SalesInvLine2G."Print Unit Price") AND
                                               (PrintOptions2G <> PrintOptions2G::"Print no lines")
                                            THEN
                                ...
                                END ELSE
                                    ...
                                    THEN
                                        IF (PrintUnitPriceOptionG = PrintUnitPriceOptionG::"Print all prices") AND (PrintOptions2G = PrintOptions2G::"Print selected lines") AND
                                           SalesInvLine2G."Print Option Line" OR
                                           (PrintUnitPriceOptionG = PrintUnitPriceOptionG::"Print all prices") AND (PrintOptions2G = PrintOptions2G::"Print all lines") OR
                                           ((PrintUnitPriceOptionG = PrintUnitPriceOptionG::"Print selected prices") AND SalesInvLine2G."Print Unit Price") AND
                                           (PrintOptions2G <> PrintOptions2G::"Print no lines")
                            ...
                            PrintOptionHelpG := (PrintOptions2G = PrintOptions2G::"Print all lines") OR
                              ((PrintOptions2G = PrintOptions2G::"Print selected lines") AND SalesInvLine2G."Print Option Line");
                            ...
                            IF PrintUnitPriceOptionG = PrintUnitPriceOptionG::"Print selected prices" THEN BEGIN
                    ...
                    dataitem("Posted Sales Trade-In"; "Posted Sales Trade-In")
                    {
                        ...
                        begin
                            IF PrintTradeInExtraG AND NOT CurrReport.PREVIEW THEN BEGIN
                            ...
                            // Start PA042846
                            IF PurchInvLineL.FINDFIRST THEN
                                // Stop PA042846
                                // Start PA040293.57855
                                // Stop PA040293.57855
                    ...
                    dataitem(HeaderFooterText; "Posted Sales Document Text")
                    {
                        ...
                        column(PrintFooterLine; PrintFooterLineBlockG)
                        {
                            Description = 'PA033336';
                        }
                ...
                dataitem(Deposit; "Integer")
                {
                    ...
                    begin
                        IF PrintDepositTicketsBlockG THEN BEGIN
                ...
                begin
                    ...
                    IF ("Sales Invoice Header"."No. Printed" > 0) AND NOT RePrintOriginalInvoiceG THEN BEGIN
                ...
                begin
                    // Start PA032727
                    // Start PA043099
                    NoOfLoopsG := ABS(NoOfDocCopiesG) + 1;
                    // Stop PA043099
            ...
            begin
                ...
                IsRepSelectionSetupAvailableG := VehicleReportSelectionG.GetFooterDetails(ReportLayoutSetupG, "Shortcut Dimension 2 Code", "Location Code",
                  REPORT::"DPG Vehicle Sales Invoice"); //API.1      20.03.18 KV
                ...
                PrintOptions2G := PrintOptionPufferG;
                PrintUnitPriceOptionG := PrintUnitPricePufferG;
                IF MixedTaxation("Sales Invoice Header"."No.") THEN BEGIN
                    PrintOptions2G := PrintOptions2G::"Print all lines";
                    PrintUnitPriceOptionG := PrintUnitPriceOptionG::"Print all prices";
                END;
                ...
                IF CurrReport.PREVIEW THEN
                    PrintDepositTicketsBlockG := FALSE;
                ...
                THEN BEGIN
                    ...
                    IF PrintSentFromLineBlockG THEN BEGIN
                ...
                IF "Sales Invoice Header"."Currency Factor" <> 0 THEN
                    ExchRateText := STRSUBSTNO(ExchangeRateTextConst, "Sales Invoice Header"."Currency Code", 1 / "Sales Invoice Header"."Currency Factor");
                // Stop DAFCZ.1
            end;
            ...
            var
                ...
                NoStringL: Text[250];
            begin
                PrintOptionPufferG := PrintOptions2G;
                PrintUnitPricePufferG := PrintUnitPriceOptionG;
                CompanyInfoG.GET;

                IF OutputSepInvoiceG THEN BEGIN
                    CLEAR(OptionInvNoL);
    ...
    requestpage
    {
        ...
        layout
        {
            area(content)
            {
                ...
                {
                    Caption = 'Options';
                    field(NoOfCopiesG; NoOfDocCopiesG)
                    {
                        Caption = 'No. of Copies';
                    }
                    field(PrintOption2G; PrintOptions2G)
                    {
                        Caption = 'Print Option';
                    }
                    field(PrintUnitPrice2G; PrintUnitPriceOptionG)
                    {
                    ...
                    field(PrintDepositTicketsG; PrintDepositTicketsBlockG)
                    {
                    ...
                    field(OutputSepInvG; OutputSepInvoiceG)
                    {
                        Caption = 'Print separate\option invoice';
                    }
                    field(ShowDiscPctG; ShowDiscountPctG)
                    {
        ...
        begin
            // Start PA033336
            OutputSepInvoiceG := FALSE;
            IF InvtSetupG.GET THEN
                PrintDepositTicketsBlockG := InvtSetupG."Print Deposit Tickets"
            ELSE
                PrintDepositTicketsBlockG := FALSE;
            // Start PA039225.51457
            PrintOptions2G := PrintOptions2G::"Print selected lines";
            PrintUnitPriceOptionG := PrintUnitPriceOptionG::"Print selected prices";
    ...
    var
        ...
        PrintOptions2G: Option "Print selected lines","Print all lines","Print no lines";
        PrintOptionPufferG: Option "0","1","2";
        PrintUnitPriceOptionG: Option "Print selected prices","Print all prices","Print no prices","3";
    ...
    begin
        ...
        IF (PrintOptions2G <> PrintOptions2G::"Print all lines") OR (PrintUnitPriceOptionG <> PrintUnitPriceOptionG::"Print all prices") THEN BEGIN
            IF (PrintOptions2G = PrintOptions2G::"Print selected lines") OR
               ((PrintOptions2G = PrintOptions2G::"Print all lines") AND (PrintUnitPriceOptionG = PrintUnitPriceOptionG::"Print selected prices")) OR
               ((PrintOptions2G = PrintOptions2G::"Print all lines") AND (PrintUnitPriceOptionG = PrintUnitPriceOptionG::"Print no prices")) OR
               (PrintOptions2G = PrintOptions2G::"Print no lines")
            THEN BEGIN
                PostedOptionVariantL.RESET;
                PostedOptionVariantL.SETRANGE(Area, PostedOptionVariantL.Area::Sale);
                ...
                IF (PrintOptions2G = PrintOptions2G::"Print selected lines") AND (PrintUnitPriceOptionG = PrintUnitPriceOptionG::"3") THEN
                    PostedOptionVariantL.SETRANGE("Print Option Line", FALSE);
                IF ((PrintOptions2G = PrintOptions2G::"Print selected lines") AND
                   (PrintUnitPriceOptionG = PrintUnitPriceOptionG::"Print selected prices")) OR
                   ((PrintOptions2G = PrintOptions2G::"Print all lines") AND (PrintUnitPriceOptionG = PrintUnitPriceOptionG::"Print selected prices")) OR
                   ((PrintOptions2G = PrintOptions2G::"Print selected lines") AND (PrintUnitPriceOptionG = PrintUnitPriceOptionG::"Print all prices"))
                THEN
                    PostedOptionVariantL.SETRANGE("Print Unit Price", FALSE);
                IF PostedOptionVariantL.FIND('-') THEN
                    REPEAT
                        IF NOT ((PrintOptions2G = PrintOptions2G::"Print selected lines") AND
                           (PrintUnitPriceOptionG = PrintUnitPriceOptionG::"Print all prices") AND
            ...
            THEN BEGIN
                ...
                IF (PrintOptions2G = PrintOptions2G::"Print selected lines") AND (PrintUnitPriceOptionG = PrintUnitPriceOptionG::"Print all prices") THEN
                    SalesLineL.SETRANGE("Print Option Line", FALSE);
                IF ((PrintOptions2G = PrintOptions2G::"Print selected lines") AND
                   (PrintUnitPriceOptionG = PrintUnitPriceOptionG::"Print selected prices")) OR
                   ((PrintOptions2G = PrintOptions2G::"Print all lines") AND (PrintUnitPriceOptionG = PrintUnitPriceOptionG::"Print selected prices"))
                THEN
    ...
    begin
        ...
        IF PostedOptionVariantL.FIND('-') THEN
            CASE ValueTypeP OF
                0:
                    IF (PrintUnitPriceOptionG <> PrintUnitPriceOptionG::"Print no prices") THEN
        ...
        IF (PrintOptions2G <> PrintOptions2G::"Print all lines") OR (PrintUnitPriceOptionG <> PrintUnitPriceOptionG::"Print all prices") THEN BEGIN
            ...
            THEN BEGIN
                ...
                IF ((PrintOptions2G = PrintOptions2G::"Print selected lines") AND
                    (PrintUnitPriceOptionG = PrintUnitPriceOptionG::"Print selected prices")) OR
                   ((PrintOptions2G = PrintOptions2G::"Print all lines") AND
                    (PrintUnitPriceOptionG = PrintUnitPriceOptionG::"Print selected prices")) OR
                   ((PrintOptions2G = PrintOptions2G::"Print all lines") AND
                    (PrintUnitPriceOptionG = PrintUnitPriceOptionG::"Print no prices")) OR
                   ((PrintOptions2G = PrintOptions2G::"Print selected lines") AND
                    (PrintUnitPriceOptionG = PrintUnitPriceOptionG::"Print all prices"))
                THEN
                    SalesLineL.SETRANGE("Print Unit Price", FALSE);
    ...
    begin
        IF ((PrintOptions2G = PrintOptions2G::"Print selected lines") AND (PrintUnitPriceOptionG = PrintUnitPriceOptionG::"Print selected prices") AND
           SalesInvLine2G."Print Option Line" AND NOT SalesInvLine2G."Print Unit Price") OR
           ((PrintOptions2G = PrintOptions2G::"Print selected lines") AND (PrintUnitPriceOptionG = PrintUnitPriceOptionG::"Print selected prices") AND
           ...
           ((PrintOptions2G = PrintOptions2G::"Print selected lines") AND (PrintUnitPriceOptionG = PrintUnitPriceOptionG::"Print all prices") AND
           NOT SalesInvLine2G."Print Option Line" AND SalesInvLine2G."Print Unit Price") OR
           ((PrintOptions2G = PrintOptions2G::"Print selected lines") AND (PrintUnitPriceOptionG = PrintUnitPriceOptionG::"Print all prices") AND
           NOT SalesInvLine2G."Print Option Line" AND NOT SalesInvLine2G."Print Unit Price") OR
           ((PrintOptions2G = PrintOptions2G::"Print all lines") AND (PrintUnitPriceOptionG = PrintUnitPriceOptionG::"Print selected prices") AND
           SalesInvLine2G."Print Option Line" AND NOT SalesInvLine2G."Print Unit Price") OR
           ((PrintOptions2G = PrintOptions2G::"Print all lines") AND (PrintUnitPriceOptionG = PrintUnitPriceOptionG::"Print selected prices") AND
           NOT SalesInvLine2G."Print Option Line" AND NOT SalesInvLine2G."Print Unit Price") OR
           (PrintUnitPriceOptionG = PrintUnitPriceOptionG::"Print no prices")
        THEN
            EXIT(FALSE);
        EXIT(TRUE);
    end;
    ...
    begin
        ...
        IF SalesInvLineL.FIND('-') THEN BEGIN
            ...
            ELSE
                SalesInvLineL.SETFILTER("VAT Calculation Type", '=%1', SalesInvLineL."VAT Calculation Type"::"Differential Tax");
            EXIT(NOT SalesInvLineL.IsEmpty());
        END;
        EXIT(FALSE);
    end;
    ...
    begin
        ...
        NoOfDocCopiesG := PrinterSelectionG.GetNoOfCopies(ReportIDL);
        // Start PA039225.51457
    end;
    ...
    begin
        ...
        IF SalesInvHdrL.FindFirst() THEN BEGIN
            IF NOT CustL.GET(SalesInvHdrL."Bill-to Customer No.") THEN
                CLEAR(CustL);
            NoOfDocCopiesG += CustL."Invoice Copies";
        END;
        // Stop PA043099
    end;
