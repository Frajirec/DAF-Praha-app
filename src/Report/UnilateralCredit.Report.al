report 80002 "DPG Unilateral Credit" // 1057702 "Unilateral Credit"
{
    // --- NAVCZ ---
    // API.1.0.4  18.10.18 DV New report based on report 31050
    // --- API Customization ---
    // --- DAFCZ ---
    // DAFCZ.1    26.10.18 DV DAFCZ.1 Added some text required by DAF CZ
    DefaultLayout = RDLC;
    RDLCLayout = './src/Report/UnilateralCredit.rdlc';
    ...
    var
        ...
        NoOfLoops: Integer;
        OutputNo: Integer;
        Text000Lbl: Label 'ANNOUNCEMENT %1';
        ...
        SummaryText: Label '%1 pay the difference of this unilateral settlement of receivables and payables of %2 %3 to company %4 to %5';
}
